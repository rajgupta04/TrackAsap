  ...
  return (
    <div className="min-h-[calc(100dvh-120px)] lg:h-[calc(100dvh-80px)] flex flex-col lg:flex-row">
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden flex flex-col min-w-0 max-w-full w-full">
          ...
          {selectedSheet && (
            ...
            >
              <div className="p-2.5 sm:p-3 flex items-center gap-2 min-w-0 max-w-full">
                ...
                <button
                  onClick={() => setShowCreateModal(true)}
                  className="p-2 bg-neon-green/20 hover:bg-neon-green/30 border border-neon-green/30 rounded-lg text-neon-green transition-all shrink-0"
                  title="New Sheet"
                >
        ...
        {/* Sheet Content */}
        <div className="flex-1 overflow-y-auto overflow-x-hidden p-2.5 sm:p-4 min-w-0 max-w-full w-full">
          {selectedSheet && currentSheet ? (
            ...
            <div className="h-full">
              {/* Mobile App Grid View (hidden on lg and up) */}
              <div className="lg:hidden space-y-4 pb-12">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    ...
                    <span className="text-xs font-bold text-white">Import Buckets</span>
                    <span className="text-[10px] text-gray-400 mt-0.5">Pre-built DSA sheets</span>
                  </button>

                  <button
                    onClick={() => setShowCreateModal(true)}
                    className="flex flex-col items-center justify-center p-3.5 bg-neon-green/10 hover:bg-neon-green/15 active:scale-95 border border-neon-green/30 rounded-xl transition-all text-center group"
                  >
                    <div className="w-10 h-10 rounded-xl bg-neon-green/20 border border-neon-green/40 flex items-center justify-center mb-2 group-hover:scale-105 transition-transform">
                      <Plus className="w-5 h-5 text-neon-green" />
                    </div>
                    <span className="text-xs font-bold text-neon-green">New Custom</span>
                    <span className="text-[10px] text-gray-400 mt-0.5">Create your own</span>
                  </button>
                </div>
                ...
                <div className="space-y-2.5 pt-1">
                  {sheets.length === 0 ? (
                    <GlassCard className="p-8 text-center">
                      ...
                      <p className="text-xs text-gray-500 mt-1">Tap Import Buckets above to get started!</p>
                    </GlassCard>
                  ) : (
                      ...
                      {sheets.map((sheet) => {
                        ...
                        return (
                          <button
                            key={sheet._id}
                            onClick={() => handleSelectSheet(sheet._id)}
                            className="w-full text-left p-4 rounded-xl bg-white/5 active:scale-[0.98] border border-white/10 hover:border-white/20 transition-all shadow-sm"
                          >
                            <div className="flex items-start gap-3">
                              <div
                                className="w-11 h-11 rounded-xl flex items-center justify-center shrink-0 shadow-inner"
                                style={{ backgroundColor: `${sheet.color}20`, borderColor: `${sheet.color}40`, borderWidth: 1 }}
                              >
                                <Icon className="w-5 h-5" style={{ color: sheet.color }} />
                              </div>
                              <div className="flex-1 min-w-0">
